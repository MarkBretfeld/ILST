...
/**
 * Die Klasse {@link FMSStatus} enth�lt alle nach BOS gültigen FMS-Status
...
public enum FMSStatus {
	...
	STATUS_C("C", "Melden Sie sich f�r Einsatzübernahme", "Melden Sie sich für Einsatz�bernahme", "Fremdhörer ausschalten"),
