...
public enum FMSStatusFahrzeug {
	...
	// Für die Werte müssen die Status an sich verwendet werden, da es hier pro
	// Orga eine andere
	// Belegung gibt.
	STATUS_1(1, "1", "Einsatzbereit über Funk", "Einsatzbereit über Funk",
			"Einsatzbereit über Funk"), STATUS_2(2, "2",
			"Einsatzbereit auf Wache", "Einsatzbereit auf Wache",
			"Einsatzbereit auf Wache"), STATUS_3(3, "3", "Einsatz übernommen",
			"Einsatz übernommen", "Einsatz übernommen"), STATUS_4(4, "4",
			"Ankunft am Einsatzort", "Ankunft am Einsatzort",
			"Ankunft am Einsatzort"), STATUS_5(5, "5", "Sprechwunsch",
			"Sprechwunsch", "Sprechwunsch"), STATUS_6(6, "6",
			"Nicht einsatzbereit", "Nicht einsatzbereit", "Temporär ausbuchen"), STATUS_7(
			7, "7", "Patient aufgenommen", "", "Infowunsch"), STATUS_8(8, "8",
			"am Transportziel", "", "Einsatz übernommen"), //
	...
	private FMSStatusFahrzeug(Integer statusNummer, String status,
